<nav x-data="{ mobileMenuOpen: false }" class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-10 md:flex md:space-x-8">
                    <a href="{{ route('public.challenges') }}" class="text-gray-600 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition">
                        Challenges
                    </a>
                    <a href="{{ route('public.opportunities') }}" class="text-gray-600 hover:text-indigo-600 px-3 py-2 text-sm font-medium transition">
                        Opportunities
                    </a>
    ...
    >
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="{{ route('public.challenges') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50">
                Challenges
            </a>
            <a href="{{ route('public.opportunities') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50">
                Opportunities
            </a>
